...
import 'package:theme_selection/screens/analytics/analytics_scrn.dart';
import 'package:theme_selection/screens/eCommerce/ecom.dart';
import 'package:theme_selection/screens/home/components/body.dart';

class ecom_scrn extends StatefulWidget {
  const ecom_scrn({Key? key}) : super(key: key);

  @override
  _ecom_scrnState createState() => _ecom_scrnState();
}

class _ecom_scrnState extends State<ecom_scrn> {
  @override
